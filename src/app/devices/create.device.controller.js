(function() {
  ...
  /** @ngInject */
  function CreateDeviceController($scope, $state, HivesService, GeoLocationService, toastr) {
    var vm = this;

      vm.center = {};
      vm.layers = {};

      vm.button_label = 'Create HiveEmpire-Sense';
    ...
    vm.onSubmit = function() {
      ...
      HivesService.create(vm.device).then(
